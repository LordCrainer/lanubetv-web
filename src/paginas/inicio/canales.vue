...
<section class="Canales">
    <v-layout row wrap justify-center align-center fill-height>
        <v-flex xs12 class="height: auto;">
            <v-card-text flat class="display-2 font-weight-bold">
                {{ items.titulo }}
            </v-card-text>
        </v-flex>
        <v-flex xs12 class="height: auto;">
          <v-layout row wrap>
            <carousel :items="items.canales"  style="height: 100%; box-shadow: 0px 0px;">
                <v-container grid-list-xl slot="contenido" slot-scope="canales" style="max-width: 800px; height: 100%;">
